...
nome_contador = "leny-play"
link_contador = "https://whos.amung.us/pingjs/"    


##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR white]||||||| LENY-PLAY|||||||[/COLOR][/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = "Addon para assistir filmes, séries e tv online"
...
#### MENU VIP ################################################################
titulo_vip = "[B][COLOR white]APENAS[/COLOR] - [COLOR gold](VIP)[/COLOR][/B]"
...
url_origem = 'https://pastebin.com/raw/zCkDAuCw'
try:
...
addon_name = xbmcaddon.Addon().getAddonInfo('Estamos atualizando, então tenha paciência.')
...
def init_SKindex(msg):
   ...
   if status_mensagem1 == 'true':
    dialog = xbmcgui.Dialog()
    link = dialog.select("[B]BEM-VINDOS AO [COLOR white]LENY-PLAY[/COLOR][/B]", [
    "[B][COLOR white]ME SIGA NO[/COLOR] FACEBOOK [/B]",
    "[B][COLOR white]ME SIGA NO[/COLOR] INSTAGRAM [/B]",
    "[B][COLOR white]ME SIGA NO[/COLOR] TWITTER [/B]",
    "[B][COLOR green] ENTRAR NO ADD-ON [/COLOR][/B]"])    
